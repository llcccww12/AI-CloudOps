...
func ProvideApp(cfg *config.Config) (*app.App, error) {
	...
	opsLeadService := opsService.NewOpsLeadService(opsExhibitionDAO, opsVisitDAO, opsCustomerDAO, logger)
	...
	opsReminderService := opsService.NewOpsReminderService(opsReminderRuleDAO, opsTrialDAO, opsContractDAO, opsSettlementDAO, opsCustomerDAO, workorderInboxDAO, opsBizService, logger)
	opsAttachmentDAO := opsDao.NewOpsAttachmentDAO(db, logger)
	opsAttachmentService := opsService.NewOpsAttachmentService(opsAttachmentDAO, opsContractDAO, opsSettlementDAO, logger)
	opsHandler := opsApi.NewOpsHandler(opsCustomerService, opsLeadService, opsBizService, opsFinanceService, opsReminderService, opsAttachmentService)
