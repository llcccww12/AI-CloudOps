...
func ProvideApp(cfg *config.Config) (*app.App, error) {
	...
	opsComputeAssetDAO := dao5.NewOpsComputeAssetDAO(db, logger)
	opsComputeAllocationDAO := dao5.NewOpsComputeAllocationDAO(db, logger)
	opsComputeService := service6.NewOpsComputeService(opsComputeAssetDAO, opsComputeAllocationDAO, opsCustomerDAO, opsContractDAO, opsActivationDAO, opsTrialDAO, opsAttachmentDAO, opsApprovalLinkDAO, logger)
	opsBizService := service6.NewOpsBizService(opsTrialDAO, opsContractDAO, opsActivationDAO, opsApprovalLinkDAO, opsCustomerDAO, opsFollowupDAO, opsSettlementDAO, opsInvoiceDAO, opsPaymentDAO, opsContractItemDAO, workorderProcessDAO, instanceService, opsComputeService, logger)
	...
	opsAttachmentService := service6.NewOpsAttachmentService(opsAttachmentDAO, opsContractDAO, opsSettlementDAO, opsExhibitionDAO, opsTrialDAO, opsActivationDAO, opsCustomerDAO, opsApprovalLinkDAO, logger)
	...
	opsHandler := api7.NewOpsHandler(opsCustomerService, opsLeadService, opsBizService, opsFinanceService, opsReminderService, opsAttachmentService, opsDashboardService, opsSurveyService, opsBillingService, opsWorkbenchService, opsManagerReportService, opsPublicFaultService, opsComputeService)
